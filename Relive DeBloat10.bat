...
::
::YAwzoRdxOk+EWAjk
::fBw5plQjdCyDJGyX8VAjFDZVWA2RNWSGIrAP4/z0/9aDp08RW+MrKd/n07mPJ+Vd+lbgPc5kmHNZl6s=
...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFDZVWA2RNWSGIrAP4/z0/9aDp08RW+MrKd/n6LGCKfYWqmHhV5oi124LyYUJFB44
::YB416Ek+ZW8=
::
::
...
:: Pobieranie debloatu
powershell -Command "Invoke-WebRequest -Uri 'https://reliveteam.eu/relivedebloat/10/debloat.exe' -OutFile '%temp%\debloat.exe'"
